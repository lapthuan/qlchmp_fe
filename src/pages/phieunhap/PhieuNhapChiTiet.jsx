...
const PhieuNhapChiTiet = () => {
    ...
    const buttonActionEdit = (props) => (
        <Link to={`../them-phieu-nhap-chi-tiet?id=${props.MaPhieuNhap}&&MaSP=${props.MaMH}&&action=edit`}>
    ...
    return (
        <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
            <Header category="Danh sách" title="Chi tiết phiếu nhập" />
            <Link to={`../them-phieu-nhap-chi-tiet?id=${id}&&action=add`}>
            ...
            >
                <ColumnsDirective>
                    ...
                    <ColumnDirective field='GiaNhap' headerText='Giá nhập' width='150' />
                    <ColumnDirective field='GiaBan' headerText='Giá bán' width='150' />
                    <ColumnDirective field='SoLuong' headerText='Số lượng' width='100' />
